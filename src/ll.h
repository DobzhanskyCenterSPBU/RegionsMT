...
void bit_set_interlocked_p(volatile uint8_t *, const size_t *);
void bit_reset_interlocked(volatile uint8_t *, size_t);
void bit_reset_interlocked_p(volatile uint8_t *, const size_t *);
...
void bit_set2_interlocked_p(volatile uint8_t *, const size_t *);

void size_inc_interlocked(volatile size_t *, const void *);
void size_dec_interlocked(volatile size_t *, const void *);
bool size_test_acquire(volatile size_t *, const void *);
...
bool bit_test2_range_acquire_p(volatile uint8_t *, const size_t *);
