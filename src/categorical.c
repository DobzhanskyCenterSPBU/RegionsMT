...
double maver_adj(uint8_t *gen, uint8_t *phen, size_t snp_cnt, size_t phen_cnt, size_t *p_rpl, size_t k, double rel_err, gsl_rng *rng, enum categorical_test_type type)
{
